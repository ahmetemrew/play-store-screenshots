    ...
    <nav className="px-4 pt-6 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto studio-panel overflow-hidden">
        <div className="flex items-center gap-4 px-5 py-4 sm:px-6">
          <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#2c221d] text-sm font-black tracking-[0.24em] text-[#f7efe7] shadow-[0_12px_30px_rgba(44,34,29,0.22)]">
          ...
          <div>
            ...
            <h1 className="mb-0 text-2xl text-[#221c18]">{studioBrand.name}</h1>
          </div>
        </div>
      </div>
    </nav>
